...
sep_lines = 10; % separation between lines (pixels)
date = '072024'; % date of analysis for file generation
...
%save fig as in supp 9D
savefig(strcat(dic,'circles',date,'.fig'))

%distance in pixels, not used in analysis, just for plots
...
%normalize mean using median (for intermediate plots only). Not used in
%analysis or in plots shown in the paper
